...
export const Verify = async (verification_code :string) => {
    ...
    try {
        ...
        const response = await axios.post("http://locahost:800/auth/verification", { verification_code: verification_code }, {
            responseType: 'json',
            withCredentials: true
        })
...
export const Logout = async () => {
    ...
    try {
        ...
        const response = await axios.post("http://locahost:800/logout", {}, {
            withCredentials: true
        })
